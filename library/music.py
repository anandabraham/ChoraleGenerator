################################################################################################################
# music.py      Version 3.2         22-Feb-2015       Bill Manaris, Nora Grossman, and Kenneth Hanson
...
class jSyn_AudioEngine():
   ...
   def add(self, sample):
      ...
      self.samples.append( sample )     # rembeber this sample
...
# used to keep track which AudioSample objects are active, so we can stop them when
# JEM's Stop button is pressed
__ActiveAudioSamples__ = []     # holds active AudioSample objects
